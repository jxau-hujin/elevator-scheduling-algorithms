 ...
 * @date: 2022/1/4
 */
public class LookSchedulingAlgorithms implements ISchedulingAlgorithms {
    @Override
    public List<Req> scheduling(List<Req> reqList, Elevator elevator) {
        ...
        Collections.sort(reverseDirectionReqList, Comparator.comparingInt(Req::getCurrentFloor));
